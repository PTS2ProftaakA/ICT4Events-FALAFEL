...
{
    public partial class RegistratieKaart : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                foreach (Plek plek in Plek.GeefBeschikbarePlekken(database))
                {
        ...
        protected void btnVolgende_OnClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect("./RegistratieProducten.aspx");
            }
        }
    }
}