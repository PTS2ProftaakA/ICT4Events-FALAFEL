<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MediaPost.aspx.cs" Inherits="ICT4Events.MediaPost" %>
...
<body>
    ...
    <div>
        <asp:Panel ID="pnlGehelePost" BorderColor="#000000" BorderWidth="1" Width="640" Height="100%" BorderStyle="Solid" runat="server">
            <asp:Label ID="lbUsername" runat="server" Text="username poster here"></asp:Label>
            <asp:Panel ID="pnlBijdrage" runat="server">
                <!-- zet hier je bijdrage in -->
            </asp:Panel>
